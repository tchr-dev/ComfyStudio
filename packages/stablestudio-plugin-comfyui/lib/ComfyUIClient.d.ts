 ...
 */
export declare type ComfyUIClientConfig = {
    serverUrl: string;
    timeout?: number;
};
export declare type ComfyUIWorkflow = {
    [nodeId: string]: {
        class_type: string;
...
export declare type QueuePromptResponse = {
    prompt_id: string;
    number: number;
    node_errors: Record<string, unknown>;
};
export declare type ComfyUIProgressEvent = {
...
export declare type ComfyUIModel = {
    name: string;
    path: string;
};
export declare type ComfyUISampler = {
    name: string;
};
export declare type ComfyUIScheduler = {
    name: string;
};

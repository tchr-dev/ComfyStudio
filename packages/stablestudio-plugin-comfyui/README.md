...
**[ComfyUI](https://github.com/comfyanonymous/ComfyUI) Plugin for StableStudio**
...
This plugin connects StableStudio to a local [ComfyUI](https://github.com/comfyanonymous/ComfyUI) installation, enabling image generation using ComfyUI's powerful node-based workflow system.
...
ComfyUI needs to allow cross-origin requests from StableStudio.
...
### 2. Start StableStudio with ComfyUI plugin
...
1. Open StableStudio at [http://localhost:3000](http://localhost:3000)
2. Go to Settings
...
- **Workflow Builder**: Constructs ComfyUI workflow graphs from StableStudio inputs
...
The plugin fetches available options from ComfyUI's `/object_info` endpoint. Restart StableStudio after adding new models.

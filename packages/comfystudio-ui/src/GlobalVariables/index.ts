...
declare global {
  ...
  type StyleableWithChildren = Styleable & { children?: ReactImport.ReactNode };
...
(globalThis as unknown as { React: typeof ReactImport }).React = ReactImport;

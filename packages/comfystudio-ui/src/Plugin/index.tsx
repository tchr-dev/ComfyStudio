...
import * as StableStudioPluginComfyUI from "@comfystudio/plugin-comfyui";
import * as StableStudioPluginExample from "@comfystudio/plugin-example";
import * as StableStudioPluginStability from "@comfystudio/plugin-stability";
import * as StableStudioPluginWebUI from "@comfystudio/plugin-webui";
  ...
  export const use = GlobalState.create<State>((set) => {
    const { createPlugin: createRootPlugin } =
      Environment.get("USE_EXAMPLE_PLUGIN") === "true"
        ...
        : Environment.get("USE_STABILITY_PLUGIN") === "true"

...
declare global {
  ...
  interface ImportMetaEnv {
    ...
    readonly VITE_USE_COMFYUI_PLUGIN: string;
    readonly VITE_USE_STABILITY_PLUGIN: string;
  }
}
...
export namespace Environment {
  ...
  const variables = {
    ...
    VITE_USE_COMFYUI_PLUGIN: import.meta.env.VITE_USE_COMFYUI_PLUGIN ?? "false",
    VITE_USE_STABILITY_PLUGIN: import.meta.env.VITE_USE_STABILITY_PLUGIN ?? "false",
  } as const;

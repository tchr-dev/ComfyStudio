import { PluginStatus } from "@comfystudio/plugin";
...
export namespace Settings {
  ...
  namespace State {
    export const use = GlobalState.create<State>((set) => ({
      developerMode:
        localStorage.getItem("comfystudio-developerMode") === "true",

      setDeveloperMode: (value) =>
        set((state) => {
          localStorage.setItem("comfystudio-developerMode", value.toString());
